      ...
      <section className="text-gray-400 bg-gray-900 body-font">
          <div className="container mx-auto max-w-screen-xl px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
              ...
              <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
                  <a href="https://formations.independence-dev.com/" target="_blank" rel="noreferrer">
                  <button
          ...
          <span className="text-xs text-gray-500 mb-1">Obtiens les</span>
          <span className="title-font font-medium">Formations</span>
        </span>
                  </button>
                  </a>
                  <a href="https://www.youtube.com/c/IndependenceDEV" target="_blank" rel="noreferrer">
                  <button
                      className="bg-gray-800 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-700 hover:bg-opacity-50 focus:outline-none">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6"
                           viewBox="0 0 576 512">
                      ...
                      <span className="ml-4 flex items-start flex-col leading-none">
          <span className="text-xs text-gray-500 mb-1">Videos gratuites</span>
