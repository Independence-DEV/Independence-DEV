  ...
  return (
      <section className="text-gray-400 bg-gray-900 body-font">
          ...
          <span className="title-font font-medium dark:group-hover:text-white">Formations</span>
                  ...
                  <a href="https://www.youtube.com/c/IndependenceDEV?sub_confirmation=1" target="_blank" rel="noreferrer">
                  <button
                      ...
                      <span className="ml-4 flex items-start flex-col leading-none">
          <span className="text-xs text-gray-500 mb-1 dark:group-hover:text-white">Videos gratuites</span>
